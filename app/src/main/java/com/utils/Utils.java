...
public class Utils {
    ...
    public static final int SHOW_ITEMS_PER_PAGE=10;
    ...
    public static void alert(String message, Context context) {
        ...
        alertDialog.setTitle("OddsOnPlay");
    ...
    public static boolean saveValueInPref(String key, String value) {
        if (key != null && value != null) {
            ...
            SharedPreferences pref = Config.getSharedInstance().applicationContext.getSharedPreferences("OddsOnPlay", Application.MODE_PRIVATE);
...
public static String optValue(JSONObject jObj,String key){
    ...
    public static void displayServerErrorMessage(JSONObject jsonObject, Context context) {
        if (jsonObject != null) {
            try {
                ...
                Utils.alert(TnHttpCom.GENERIC_ERROR_MESSAGE, context);
            }
        } else {
            Utils.alert(TnHttpCom.GENERIC_ERROR_MESSAGE, context);
        }
...
//    }
    ...
    public static String getAppVersion() {
        ...
        try {
           ...
           PackageInfo pInfo = myPackageMgr.getPackageInfo("com.purpleyo.oddsonplay", 0);
    ...
    public static void shareDefault(String textToShare, String website) {
        ...
        Config.getSharedInstance().applicationContext.startActivity(Intent.createChooser(share, "Share \"OddsOnPlay\""));
...
//            if(PyoCurrentUser.getSharedInstance().getCurrentDeviceMobileNumber()==null) {
...
//                PyoCurrentUser.getSharedInstance().setCurrentDeviceMobileNumber(tMgr.getLine1Number());
//            }
        }
